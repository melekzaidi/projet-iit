...
$claviers = $product->selectProductsByCategory("Ordinateurs portables");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <nav id="navigation">
        <div class="container">
            ...
            <ul class="main-nav nav navbar-nav">
                    ...
                    <li class="active"><a href="PC.php">Ordinateurs Portables</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title">
                        <h3 class="title">Ordinateurs Portables</h3>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="row">
