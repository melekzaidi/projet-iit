...
$claviers = $product->selectProductsByCategory("Accessoires informatiques");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <nav id="navigation">
        <div class="container">
            ...
            <ul class="main-nav nav navbar-nav">
                    ...
                    <li class="active"><a href="Accs.php">Autres Accessories</a></li>
                </ul>
            </div>
        </div>
    </nav>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title">
                        <h3 class="title">Autres Accessories</h3>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="row">
